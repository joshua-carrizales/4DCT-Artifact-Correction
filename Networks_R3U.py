...
class R3U_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=1,t=2):
        super(R3U_Net,self).__init__()
...
class AttU_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=1):
        ...
        self.Conv0 = conv_block(ch_in=img_ch,ch_out=32)
...
class R3AttU_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=1,t=2):
        super(R3AttU_Net,self).__init__()
